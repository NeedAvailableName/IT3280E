...
.data
MaxMessage:	.asciiz "The largest value is "
MinMessage: 	.asciiz "The smallest value is "
MaxIndex:	.asciiz "The largest element is stored in $s"
MinIndex:	.asciiz "The smallest element is stored in $s"
.text
main: 	li $s0, 5
	li $s1, 3
	li $s2, 2
	...
	nop
	li $v0, 56		
	la $a0, MaxIndex	# print index of max element
	add $a1,$t8,$zero
	syscall
	la $a0, MaxMessage		# print max value
	add $a1,$t0,$zero
	syscall	
	la $a0, MinIndex	# print index of min value
	add $a1,$t9,$zero
	syscall
	la $a0, MinMessage		# print min value
	add $a1,$t1,$zero
	syscall
